...
const columnsData = [
  ...
  { accessor: 'pitch_usage_percentage', title: 'Pitch Usage Percentage', sortable: true, draggable: true  },
  { accessor: 'average_speed', title: 'Average Pitch Speed', sortable: true, draggable: true  },
  { accessor: 'average_horizontal_break', title: 'Average Horizontal Break', sortable: true, draggable: true  },
  { accessor: 'average_vertical_break', title: 'Average Induced Vertical Break', sortable: true, draggable: true  },
  { accessor: 'average_spin_rate', title: 'Average Spin Rate', sortable: true, draggable: true  },
  { accessor: 'average_exit_speed', title: 'Average Hit Exit Speed', sortable: true, draggable: true  },
  { accessor: 'average_launch_angle', title: 'Average Hit Launch Angle', sortable: true, draggable: true  },
];
